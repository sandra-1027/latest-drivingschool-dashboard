...
const ResetPasswordForm = () => {
  ...
  const handleChangePassword = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setError("");
    setMessage("");
    console.log("Reset token:", keyword_encode);
    try {
      ...
      <main className="grid w-full grow grid-cols-1 place-items-center">
        <div className="w-full max-w-[26rem] p-4 sm:px-5">
          <div className="text-center">
            <img className="mx-auto size-16" src="/logo.png" alt="logo" />
            <div className="mt-4">
          ...
          <div className="card mt-5 rounded-lg p-5 lg:p-7">
            <form onSubmit={handleChangePassword}>
              ...
              <div className="mt-4 flex items-center justify-between space-x-2"></div>
              <button
                type="submit"
