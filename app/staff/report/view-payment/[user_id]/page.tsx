...
// <div dangerouslySetInnerHTML={{__html:billData.address}}/>
//  <p>
//     <br />Tel No: {billData.phone}
//     <br />Email: {billData.email}</p>
// </div>
  ...
  return (
    <div className="w-full pb-8">
      <div className="flex items-center space-x-4 py-5 lg:py-6">
        ...
        <ul className="hidden flex-wrap items-center space-x-2 sm:flex">
          <li className="flex items-center space-x-2">
            <a className="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="#">Home</a>
          </li>
        </ul>
      </div>
...
//       <div className="mt-3 flex justify-end">
//  <button  className="printnone inline-flex items-center space-x-2 px-4 py-2 bg-[#dc3545] text-white rounded-md">
//   <span>Print</span>
//   <IoMdPrint />
// </button>
//   </div>
