...
//     try {
//       const response = await fetch(`/api/students?qrCode=${data}`);
...
import StudentProfile from "../student/page";
import Scanner from "./Scanner";

export default function Home() {
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold">QR Code Student Attendance</h1>
