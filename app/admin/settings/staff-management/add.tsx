...
const Add: React.FC<CreateProps> = ({
  showmodal,
  togglemodal,
  formData,
  isEditing,
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const endpoint = isEditing
      ? "/api/admin/settings/update_staff"
      : "/api/admin/settings/add_staff";
    ...
    try {
      ...
      if (!response.ok) {
        alert(
          `Failed to ${isEditing ? "update" : "add"} staff. Status code: ${
            response.status
          }`
        );
        return;
