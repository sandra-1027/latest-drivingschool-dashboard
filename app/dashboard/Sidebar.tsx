          ...
          {isDrawerVisible && (
            <div className="sidebar-panel">
              ...
              <div className="flex h-18 w-full items-center justify-between pl-4 pr-1">
                ...
                {data?.user_type === "admin" ? (  
                   <p className="text-base tracking-wider text-slate-800 dark:text-navy-100">Admin   </p>
                   ) : data?.user_type === "staff" ? ( 
                    <p className="text-base tracking-wider text-slate-800 dark:text-navy-100">Staff </p>
                    ): null} 
...
{/* <li>
 ...
 <li className="ac nav-parent [&.is-active_svg]:rotate-90 [&.is-active_.ac-trigger]:font-semibold [&.is-active_.ac-trigger]:text-slate-800 dark:[&.is-active_.ac-trigger]:text-navy-50">
      ...
      <ul className={`ac-panel ${isDropdownOpens ? 'block' : 'hidden'}`}>
        <li>
          <Link href="/staff/report/payment-history" className="nav-link flex items-center justify-between p-2 text-xs+ tracking-wide outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4">
            <div className="flex items-center space-x-2">
              <div className="size-1.5 rounded-full border border-current opacity-40" />
              <span>Payment History</span>
            </div>
