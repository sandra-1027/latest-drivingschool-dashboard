...
//   <div className="drawer-overlay fixed inset-0 z-[150] hidden bg-slate-900/60" />
...
//         </p>
//         <p data-header="#right-sidebar-tab-project" className="right-sidebar-header flex shrink-0 items-center space-x-1.5">
...
//         </p>
//         <p data-header="#right-sidebar-tab-activity" className="right-sidebar-header flex shrink-0 items-center space-x-1.5">
//           <svg xmlns="http://www.w3.org/2000/svg" className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
//             <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
//           </svg>
//           <span className="text-xs">Activity</span>
//         </p>
//         <button data-close-drawer className="btn -mr-1 size-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
//           <svg xmlns="http://www.w3.org/2000/svg" className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
//             <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
//           </svg>
//         </button>
//       </div>
//       <div id="right-sidebar-tab-home" className="tab-content tab-shift-up is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1">
...
//             <svg xmlns="http://www.w3.org/2000/svg" className="size-4.5 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
...
//                 </p>
//                 <svg xmlns="http://www.w3.org/2000/svg" className="size-4.5 text-secondary dark:text-secondary-light" viewBox="0 0 20 20" fill="currentColor">
...
//                 <button className="btn -ml-1 size-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
//                   <svg xmlns="http://www.w3.org/2000/svg" className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
...
//                 </p>
//                 <svg xmlns="http://www.w3.org/2000/svg" className="size-4.5 text-success" viewBox="0 0 20 20" fill="currentColor">
...
//                 <img className="size-10" src="/images/100x100.png" alt="image" />
//                 <div>
...
//                   </div>
//                   <div className="flex">
//                     <button className="btn size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
//                       <svg xmlns="http://www.w3.org/2000/svg" className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
//                 </div>
//               </div>
//               <img src="/images/800x600.png" className="size-20 rounded-lg object-cover object-center" alt="image" />
//             </div>
//             <div className="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
//               <div className="flex flex-1 flex-col justify-between">
//                 <div className="line-clamp-2">
...
//         <div className="h-18" />
//       </div>
//       <div id="right-sidebar-tab-project" className="tab-content tab-shift-up is-scrollbar-hidden overflow-y-auto overscroll-contain px-3 pt-1">
...
//                 14
//               </p>
//               <svg xmlns="http://www.w3.org/2000/svg" strokeWidth="1.5" className="size-5 text-primary dark:text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                 <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
//               </svg>
//             </div>
...
//                 36
//               </p>
//               <svg xmlns="http://www.w3.org/2000/svg" className="size-5 text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
//             <img className="size-10 rounded-lg object-cover object-center" src="/images/illustrations/lms-ui.svg" alt="image" />
//             <div>
...
//         <div className="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
//           <div className="flex items-center space-x-3">
//             <img className="size-10 rounded-lg object-cover object-center" src="/images/illustrations/store-ui.svg" alt="image" />
//             <div>
//               <p className="font-medium leading-snug text-slate-700 dark:text-navy-100">
//                 Store Dashboard
//               </p>
...
//         <div className="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
//           <div className="flex items-center space-x-3">
//             <img className="size-10 rounded-lg object-cover object-center" src="/images/illustrations/chat-ui.svg" alt="image" />
//             <div>
//               <p className="font-medium leading-snug text-slate-700 dark:text-navy-100">
//                 Chat Mobile App
//               </p>
...
//         <div className="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
//           <div className="flex items-center space-x-3">
//             <img className="size-10 rounded-lg object-cover object-center" src="/images/illustrations/nft.svg" alt="image" />
//             <div>
//               <p className="font-medium leading-snug text-slate-700 dark:text-navy-100">
//                 NFT Marketplace App
//               </p>
...
//         <div className="h-18" />
//       </div>
//       <div id="right-sidebar-tab-activity" className="tab-content tab-shift-up is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1">
//         <div className="mx-3 flex flex-col items-center rounded-lg bg-slate-100 py-3 px-8 dark:bg-navy-600">
//           <svg xmlns="http://www.w3.org/2000/svg" className="size-8 text-secondary dark:text-secondary-light" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
//             <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
//           </svg>
...
//               <div className="avatar mt-2 size-20">
...
//           <button data-target="#right-sidebar-tab-home" data-active-class="text-primary dark:text-accent [&_svg:last-child]:hidden" data-default-class="[&_svg:first-child]:hidden" className="tab btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
...
//             </svg>
//           </button>
//           <button data-target="#right-sidebar-tab-project" data-active-class="text-primary dark:text-accent [&_svg:last-child]:hidden" data-default-class="[&_svg:first-child]:hidden" className="tab btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
//             <svg xmlns="http://www.w3.org/2000/svg" className="size-5 shrink-0" viewBox="0 0 20 20" fill="currentColor">
//               <path fillRule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
//             </svg>
//             <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="size-5 shrink-0" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
//               <path strokeLinecap="round" strokeLinejoin="round" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
//             </svg>
//           </button>
//           <button data-target="#right-sidebar-tab-activity" data-active-class="text-primary dark:text-accent [&_svg:last-child]:hidden" data-default-class="[&_svg:first-child]:hidden" className="tab btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
//             <svg xmlns="http://www.w3.org/2000/svg" className="size-5 shrink-0" viewBox="0 0 20 20" fill="currentColor">
//               <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
//             </svg>
//             <svg xmlns="http://www.w3.org/2000/svg" className="size-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
